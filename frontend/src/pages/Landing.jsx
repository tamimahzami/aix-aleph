...
import HeartbeatHero from "../components/Hero/HeartbeatHero.jsx";
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={f.t} className="panel p-5 transition-transform hover:-translate-y-0.5">
                ...
                <Link className="btn btn-ghost mt-4" to={f.to}>{f.b}</Link>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            <Link
              ...
              to="/dashboard"
              onMouseEnter={() => { import("./Dashboard.jsx"); }}
            >
              Jetzt Demo öffnen
            </Link>
