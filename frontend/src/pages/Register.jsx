  ...
  return (
    <SimplePage title="Register">
      <form className="space-y-3">
        <input className="w-full px-3 py-2 rounded-md border border-[var(--color-line)] bg-transparent" placeholder="Name" />
        ...
        <button className="btn btn-primary">Konto erstellen</button>
      </form>
    </SimplePage>
  );
}
